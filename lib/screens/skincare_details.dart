...
class SkincareDetailsScreen extends StatefulWidget {
  ...
  const SkincareDetailsScreen({
    super.key,
    required this.product,
  });

  @override
  State<SkincareDetailsScreen> createState() =>
      _SkincareDetailsScreenState();
}

class _SkincareDetailsScreenState
    extends State<SkincareDetailsScreen> {
