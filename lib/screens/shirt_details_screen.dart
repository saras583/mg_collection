...
class ShirtDetailsScreen extends StatefulWidget {
  ...
  const ShirtDetailsScreen({
    super.key,
    required this.product,
  });

  @override
  State<ShirtDetailsScreen> createState() =>
      _ShirtDetailsScreenState();
}

class _ShirtDetailsScreenState
    extends State<ShirtDetailsScreen> {
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const Text(
                        ...
                        "Premium quality shirt, comfortable and stylish for everyday wear.",
