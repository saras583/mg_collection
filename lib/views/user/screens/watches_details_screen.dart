...
class WatchesDetailsScreen extends StatefulWidget {
  ...
  const WatchesDetailsScreen({
    super.key,
    required this.product,
  });

  @override
  State<WatchesDetailsScreen> createState() =>
      _WatchesDetailsScreenState();
}

class _WatchesDetailsScreenState
    extends State<WatchesDetailsScreen> {
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const Text(
                        ...
                        "Premium watch with stylish design and durable build quality. Perfect for daily use and special occasions.",
