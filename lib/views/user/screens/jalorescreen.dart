...
import 'package:mgcollection_app/views/user/screens/joloredetailedscreens.dart';
...
class _JalorescreenState extends State<Jalorescreen> {
  ...
  Future<List<Map<String, dynamic>>> getJewellery() async {
    ...
    final jewellery = List<Map<String, dynamic>>.from(data);
            ...
            Expanded(
              child: FutureBuilder<List<Map<String, dynamic>>>(
                ...
                builder: (context, snapshot) {
                  ...
                  final jewellery = snapshot.data ?? [];

                  if (jewellery.isEmpty) {
                    return const Center(
                      child: Text('No Jewellery Found'),
                    );
                  }
                      ...
                      return GestureDetector(
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (_) => JewelleryDetailsScreen(
                                product: item,
                              ),
                            ),
                          );
