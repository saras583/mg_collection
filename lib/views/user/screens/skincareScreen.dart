...
import 'package:mgcollection_app/views/user/screens/skincare_details.dart';
...
class _SkincarescreenState extends State<Skincarescreen> {
  ...
  Future<List<Map<String, dynamic>>> getSkincare() async {
    ...
    final skincare = List<Map<String, dynamic>>.from(data);
            ...
            Expanded(
              child: FutureBuilder<List<Map<String, dynamic>>>(
                ...
                builder: (context, snapshot) {
                  ...
                  final skincare = snapshot.data ?? [];

                  if (skincare.isEmpty) {
                    return const Center(
                      child: Text('No Skincare Found'),
                    );
                  }
                      ...
                      return GestureDetector(
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (_) => SkincareDetailsScreen(
                                product: item,
                              ),
                            ),
                          );
